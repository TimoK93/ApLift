...
if __name__ == "__main__":
	...
	parser.add_argument('--seqName', default="MOT20-01", type=str)
	parser.add_argument('--FilePath', default="/home/kaiser/code_dev/OfficialDifferentiableTracker/results/MOT20-Test/MOT20-01/MOT20-01.txt", type=str)
	parser.add_argument('--image_dir', default="/home/kaiser/code_dev/OfficialDifferentiableTracker/data/tmp/MOT20/train/MOT20-01/img1", type=str)
	parser.add_argument('--output_dir', default="/home/kaiser/code_dev/OfficialDifferentiableTracker/vid", type=str)
	parser.add_argument('--displayName', default="/home/kaiser/code_dev/OfficialDifferentiableTracker/det", type=str)
